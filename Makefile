...
# Create databases
create-dbs:
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "CREATE DATABASE $(DB_NAME_DEV);"
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "CREATE DATABASE $(DB_NAME_TEST);"
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "GRANT ALL PRIVILEGES ON DATABASE $(DB_NAME_DEV) TO $(DB_USER);"
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "GRANT ALL PRIVILEGES ON DATABASE $(DB_NAME_TEST) TO $(DB_USER);"
...
# Drop databases
drop-dbs:
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "DROP DATABASE IF EXISTS $(DB_NAME_DEV);"
	PGPASSWORD=$(DB_PASSWORD) $(PSQL) -h $(DB_HOST) -U $(DB_USER) -c "DROP DATABASE IF EXISTS $(DB_NAME_TEST);"
